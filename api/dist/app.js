...
var app = routing_controllers_1.createExpressServer({
    currentUserChecker: function (action) { return __awaiter(void 0, void 0, void 0, function () {
        var token;
        return __generator(this, function (_a) {
            token = action.request.headers['authorization'];
            return [2 /*return*/, authentication_middleware_1.AuthenticationService.getUserByToken(token)];
        });
    }); },
